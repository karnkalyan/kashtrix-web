      ...
      <div className="pt-16 pb-20 bg-[#FFFFFF]">
        <div className="max-w-4xl mx-auto px-4 sm:px-6 lg:px-8 space-y-8 text-[#1B1024]">
          <div className="text-center space-y-3">
            ...
            <h1 className="text-3xl sm:text-4xl font-bold font-sora text-[#2B0D3A]">Privacy Policy</h1>
            <p className="text-xs text-[#6F6078]">Effective Date: March 30, 2026 | Last Updated: March 2026</p>
          </div>

          <div className="p-8 rounded-3xl bg-[#F8F7FA] border border-[#E8DFF0] space-y-6 text-sm leading-relaxed">
            <section className="space-y-2">
              <h2 className="text-base font-bold font-sora text-[#2B0D3A]">1. Scope of Subscriber &amp; Telemetry Data</h2>
              <p>
            ...
            <section className="space-y-2">
              <h2 className="text-base font-bold font-sora text-[#2B0D3A]">2. Data Isolation &amp; Zero-Trust Processing</h2>
              <p>
            ...
            <section className="space-y-2">
              <h2 className="text-base font-bold font-sora text-[#2B0D3A]">3. AI Agent Model Training &amp; Privacy</h2>
              <p>
            ...
            <section className="space-y-2">
              <h2 className="text-base font-bold font-sora text-[#2B0D3A]">4. GDPR &amp; Global Compliance Rights</h2>
              <p>
