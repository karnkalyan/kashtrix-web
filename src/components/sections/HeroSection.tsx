...
export const HeroSection: React.FC<HeroSectionProps> = ({ onRequestDemo }) => {
  return (
    <section className="relative flex min-h-[100svh] w-full items-center overflow-hidden border-b border-[#E8DFF0] bg-[linear-gradient(135deg,#FFFFFF_0%,#FBFAFC_58%,#F4EEFF_100%)] px-0 pb-12 pt-28 text-[#1B1024] dark:border-[#342044] dark:bg-[radial-gradient(circle_at_72%_32%,rgba(74,27,122,0.22),transparent_42%),linear-gradient(135deg,#09050F_0%,#120819_58%,#1A0D24_100%)] dark:text-white sm:pb-14 sm:pt-28 lg:pb-16 lg:pt-28">
      ...
      <div className="relative z-20 mx-auto max-w-[1440px] px-5 sm:px-8 lg:px-10 xl:px-12">
        <div className="grid grid-cols-1 items-center gap-14 lg:grid-cols-12 lg:gap-12 xl:gap-16">
          ...
          >
            {/* Hero Badge */}
            <div className="mb-7 inline-flex items-center gap-2 rounded-full border border-[#E8DFF0] bg-white/80 px-3.5 py-1.5 shadow-sm backdrop-blur-sm dark:border-[#342044] dark:bg-[#1A0D24]/80">
              <span className="h-2 w-2 rounded-full bg-[#E11D72]" />
              <span className="font-sora text-[11px] font-semibold uppercase tracking-[0.08em] text-[#2B0D3A]">
                AI-Native Telecom OSS/BSS &amp; Automation Platform
              </span>
            </div>

            <h1 className="font-sora text-[clamp(2.65rem,6.5vw,4.5rem)] font-bold leading-[1.02] tracking-[-0.055em] text-[#2B0D3A]">
              <span className="block">Where networks,</span>
              <span className="block">business and AI</span>
              <span className="relative inline-block text-[#E11D72]">
                work together.
                <span className="absolute -bottom-2 left-0 h-1 w-full rounded-full bg-[#E11D72]/20" />
              </span>
            </h1>

            <p className="mx-auto mt-8 max-w-[610px] font-inter text-base leading-7 text-[#5F5267] lg:mx-0 lg:text-[17px]">
            ...
            <div className="mt-8 flex flex-col items-center justify-center gap-3 sm:flex-row lg:justify-start">
              ...
              <Link
                href="/platform"
                className="group flex w-full items-center justify-center gap-2 rounded-xl border border-[#DCCFE5] bg-white px-7 py-3.5 font-inter text-sm font-semibold text-[#2B0D3A] shadow-sm transition-all duration-300 hover:-translate-y-0.5 hover:border-[#4A1B7A] hover:bg-[#F8F5FC] sm:w-auto"
              >
            ...
            <div className="mt-8 flex flex-wrap items-center justify-center gap-x-6 gap-y-3 border-t border-[#E8DFF0] pt-6 font-inter text-xs font-semibold text-[#514458] lg:justify-start">
