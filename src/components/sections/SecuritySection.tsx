      ...
      <div className="max-w-7xl mx-auto px-4 sm:px-6 lg:px-8">
            ...
            return (
              <div
                ...
                className={cn(
                  ...
                  activeTab === index
                    ? "bg-[#2B0D3A] text-white border-[#4A1B7A] shadow-lg scale-102"
                ...
                <div>
                  <div
                    className={cn(
                      ...
                      activeTab === index ? "bg-[#E11D72] text-white" : "bg-[#F4EEFF] text-[#4A1B7A]"
                    )}
                  >
                    <Icon className="w-6 h-6 stroke-[1.75]" />
                  </div>
                  <h3 className="text-base font-bold font-sora mb-2 leading-snug">{item.title}</h3>
                  <p className={cn("text-xs leading-relaxed", activeTab === index ? "text-[#E8DFF0]/90" : "text-[#6F6078]")}>
                    {item.desc}
                  </p>
                </div>
              </div>
        ...
        <div className="rounded-2xl bg-[#1B1024] border border-[#342044] p-6 text-white font-inter text-xs">
          <div className="flex items-center justify-between pb-3 mb-4 border-b border-[#342044]">
            <span className="text-[#9B82B5] font-semibold flex items-center gap-2">
              <Terminal className="w-4 h-4 text-[#E11D72]" /> Real-Time SOC 2 Compliance &amp; Audit Log Stream
            </span>
            <span className="text-[10px] text-[#E11D72] uppercase font-bold tracking-wider">
          ...
          <div className="space-y-2.5 text-[#F4EEFF] leading-relaxed">
            <div className="flex items-start gap-2">
              <span className="text-[#6F6078] shrink-0">[2026-03-30 14:22:01 UTC]</span>
              <span>
                <strong className="text-[#E11D72]">AUTH_VERIFIED</strong> | User: AI_NOC_AGENT_01 | Token: HMAC_SHA256_VERIFIED | Action: Query gNMI telemetry on Cisco ASR-9000-BNG-01.
              </span>
            </div>
            <div className="flex items-start gap-2">
              <span className="text-[#6F6078] shrink-0">[2026-03-30 14:22:04 UTC]</span>
              <span>
            ...
            <div className="flex items-start gap-2">
              <span className="text-[#6F6078] shrink-0">[2026-03-30 14:22:06 UTC]</span>
              <span>
