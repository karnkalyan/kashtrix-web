      ...
      <div className="relative z-10 mx-auto grid max-w-7xl gap-10 px-4 sm:px-6 lg:grid-cols-12 lg:px-8">
        <div className="space-y-7 lg:col-span-5">
          ...
          <div className="rounded-2xl bg-[#2B0D3A] p-6 text-white">
            ...
            <div className="mt-5 text-sm"><a className="flex items-center gap-2 hover:text-[#F9A8D4]" href="mailto:info@kashtrix.com"><Mail className="h-4 w-4" /> info@kashtrix.com</a></div>
          </div>
        </div>
